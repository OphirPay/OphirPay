...
> For a complete guide to the refund lifecycle, reason-code catalog (0–5), state transitions, authorization rules, and bounded analytics window, see **[Refund System Guide](REFUNDS.md)**.
