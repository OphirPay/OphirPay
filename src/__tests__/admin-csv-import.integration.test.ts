...
vi.mock("@/lib/prisma", () => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-require-imports -- vi.mock factories are hoisted above imports; require is needed to load @prisma/client dynamically inside the factory
