...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Desktop sidebar */}
      <aside aria-label="Sidebar" className="hidden lg:flex fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 z-40 flex-col">
        <div className="flex items-center gap-3 px-6 h-16 border-b border-gray-200 dark:border-gray-800">
          ...
          <div>
            <span className="text-lg font-bold text-gray-900 dark:text-white leading-none block">OphirPay</span>
      ...
      {/* Mobile sidebar */}
      <aside aria-label="Mobile Navigation" className={cn(
        ...
        <div className="flex items-center gap-3 px-6 h-16 border-b border-gray-200 dark:border-gray-800">
          ...
          <div><span className="text-lg font-bold text-gray-900 dark:text-white leading-none block">OphirPay</span></div>
        </div>
