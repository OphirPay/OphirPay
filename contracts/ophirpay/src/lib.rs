...
pub enum PaymentError {
    ...
    // [Reserved: 15..=16] Token transfer / balance errors

    // ── Payments & Circuit Breaker (17-21) ─────────────────────
    ...
    // [Reserved: 33..=34] Recurring schedule lifecycle & fee lookup

    // ── Fees & Timelocks (35-38) ───────────────────────────────
    ...
    // [Reserved: 43..=44] Governance quorum & proposal defeat
    ...
    // ── Refunds & Reentrancy (47-48, 51-52) ────────────────────
    /// Refund not found
    RefundNotFound = 47,
    /// Refund already processed
    RefundAlreadyProcessed = 48,

    // [Reserved: 49..=50] Refund history & window

    /// Already voted: duplicate vote on proposal
    AlreadyVoted = 51,
    /// Reentrant call detected: operation blocked by reentrancy guard
    ReentrantCall = 52,

    // [Reserved: 53..=61] Spending caps, dispute resolution & market stability

    // ── Hooks (62) ─────────────────────────────────────────────
    /// Hook not found
    HookNotFound = 62,

    // [Reserved: 63..=64] Hook collisions & rate limiting

    // ── Assets (65) ────────────────────────────────────────────
    /// Asset not supported: invalid or unapproved asset address
    AssetNotSupported = 65,

    // [Reserved: 66..=90] Protocol parameters, recipient limits & streaming bounds

    // ── Signer Limits (91) ─────────────────────────────────────
    /// Maximum signers exceeded
    MaxSignersExceeded = 91,

    // [Reserved: 92..=300] Advanced DeFi, privacy, analytics, and interoperability

    // ── Two-Step Revocation & Invariant Guards (301-308) ────────
