...
export const PAGE_DESCRIPTIONS = {
  ...
  ESCROWS: "Manage secure condition-based and deadline-gated escrow contracts on Stellar.",
  ESCROW_DETAIL: "Inspect escrow release conditions, dispute arbitration, and claims.",
  ...
  WEBHOOK_DELIVERIES: "Monitor webhook delivery status, latency, and redeliver failed payloads.",
