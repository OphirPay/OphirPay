...
export const PAGE_DESCRIPTIONS = {
  ...
  STREAMS: "Manage continuous linear token payment streams and vesting on Stellar.",
  STREAM_DETAIL: "Inspect stream vesting progress, claimable tokens, and settlement status.",
