...
### Added
- **Donor self-serve export**: Added an authenticated endpoint (`/api/donations/export`) and a dedicated page (`/donations`) for users to export their own donations history as CSV or JSON.
