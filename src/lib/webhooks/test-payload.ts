...
//
// Integrator test-event payload builder. Produces a realistic but clearly
// fake envelope; the `test` flag on both the envelope and the data lets
// receivers skip side effects.
